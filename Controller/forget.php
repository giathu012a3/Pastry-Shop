    ...
    case 'forget_action':
        if (isset($_POST['submit_email'])) {
            ...
            if ($checkemail > 0) {
                ...
                $mail->Username = "nguyengiathu24052004@gmail.com"; // địa chỉ của trang web
                // GMAIL password
                // $mail->Password = "php22023ngoc";
                // $mail->Password = "kxws tlbl pjob ipjx"; //mật khẩu ứng dụng
                $mail->Password = "uesm ther eiwu chtu"; //mật khẩu ứng dụng
                $mail->SMTPSecure = "tls";  // ssl
                // sets GMAIL as the SMTP server
                $mail->Host = "smtp.gmail.com";
                // set the SMTP port for the GMAIL server
                $mail->Port = "587"; // 465
                $mail->From = 'nguyengiathu24052004@gmail.com';
                $mail->FromName = 'Nguyen Gia Thu';
