...
<div class="container-fluid login">
  ...
  <div class="container">
    ...
    <div class="row table-login">
      <div class="col-xs-12 col-sm-12 col-md-5 well well-sm col-md-offset-4 mt-4 header-login">
        <h2 class="text-center ">  Đăng kí tài khoản
        </h2>
          ...
          <div class="card-body">
              <div class="row">
                ...
                <label for="email">Tên khách Hàng:</label>
                    ...
                    <div class="col-xs-1 col-md-1 col-sm-1 icon-login">
